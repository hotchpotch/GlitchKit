#
#  Be sure to run `pod spec lint GlitchKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Yuichi Tateno" => "hotchpotch@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Yuichi Tateno', 'other author'
  ...
  s.source       = { :git => "https://github.com/hotchpotch/GlitchKit.git" }
